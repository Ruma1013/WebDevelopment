...
const OverviewCounter = () => {
  return (
    <section className='dark:bg-slate-900 container h-12 md:h-32 p-3 '>
      <div className='grid grid-cols-4 divide-x divide-slate-700 mx-auto w-full md:max-w-[800px] shadow-lg bg-white -translate-y-16 md:-translate-y-20 p-3 my-4 md:p-8 dark:bg-gray-800 dark:text-white/70 '>
        ...
        <div className='flex flex-col items-center justify-center'>
          <h1 className='text-sm font-bold text-black/80 dark:text-white sm:text-lg md:text-3xl'>
            <CountUp end={160527} duration={2.75} 
